...
function useLibraryData(page: number, perPage: number, filters: FilterParams) {
    return useQuery({
        queryKey: ['libraries', page, perPage, filters],
        queryFn: async () => {
            const params: any = {
                page,
                per_page: perPage,
...
export default function Library(props: Props) {
    ...
    const { data, isLoading, isFetching } = useLibraryData(
